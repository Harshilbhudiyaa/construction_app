...
class MachineModel {
  ...
  factory MachineModel.fromJson(Map<String, dynamic> json) {
    return MachineModel(
      ...
      type: MachineType.values.firstWhere((e) => e.name == json['type']),
      assignedSiteId: json['assignedSiteId'],
      assignedSiteName: json['assignedSiteName'],
      natureOfWork: json['natureOfWork'] != null 
        ? NatureOfWork.values.firstWhere((e) => e.name == json['natureOfWork']) 
        : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'natureOfWork': natureOfWork?.name,
      'status': status.name,
