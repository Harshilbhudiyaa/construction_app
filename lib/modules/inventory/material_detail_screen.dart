        ...
        children: [
          Positioned.fill(
            child: material.photoUrl != null
                ...
                : Center(child: Icon(material.category.icon, size: 100, color: Colors.white.withOpacity(0.05))),
          ),
          Positioned.fill(
            child: Container(
              decoration: BoxDecoration(
              ...
              children: [
                ...
                Consumer<SiteService>(
                  builder: (context, siteService, child) {
                    final site = siteService.getSiteById(material.siteId);
                    final siteName = site?.name ?? 'Assigned Site';
                    return Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                      decoration: BoxDecoration(color: Colors.blueAccent.withOpacity(0.2), borderRadius: BorderRadius.circular(4)),
                      child: Text('SITE: $siteName', style: const TextStyle(color: Colors.white70, fontSize: 10, fontWeight: FontWeight.bold)),
                    );
                  },
                ),
              ],
              ...
              builder: (context, snapshot) {
                ...
                return ProfessionalCard(
                  ...
                  child: InkWell(
                    ...
                    borderRadius: BorderRadius.circular(16),
                    child: ListTile(
                      leading: const Icon(Icons.business_rounded, color: AppColors.deepBlue),
                      title: Text(party?.name ?? 'Loading...', style: const TextStyle(fontWeight: FontWeight.bold)),
                      subtitle: Text(party?.contactNumber ?? ''),
                      trailing: const Icon(Icons.chevron_right_rounded, color: AppColors.steelBlue),
                    ),
                  ),
                );
              },
              ...
              child: Column(
                children: [
                   ListTile(
                    ...
                    trailing: const Icon(Icons.download_rounded, color: AppColors.steelBlue),
                  ),
                  if (material.billingDetails?.billPhotoUrl != null) ...[
                    ...
                    ListTile(
                      ...
                      trailing: const Icon(Icons.visibility_rounded, color: AppColors.steelBlue),
                    ),
                  ],
                ],
              ),
  ...
  Widget _financeRow(String label, String value, {bool isBold = false, Color? color}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: TextStyle(color: AppColors.steelBlue, fontWeight: isBold ? FontWeight.bold : FontWeight.normal)),
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: AppColors.deepBlue.withOpacity(0.1), shape: BoxShape.circle),
                  child: const Icon(Icons.edit_note_rounded, size: 16, color: AppColors.deepBlue),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(log.description, style: const TextStyle(fontSize: 12, color: AppColors.steelBlue)),
                      const SizedBox(height: 4),
                      Text(
                        DateFormat('dd MMM, hh:mm a').format(log.timestamp),
                        style: TextStyle(fontSize: 10, color: AppColors.steelBlue.withOpacity(0.7)),
                      ),
                    ],
                  ),
                ),
        ...
        children: [
          ...
          if (billing.billPhotoUrl != null) ...[
            ...
            ClipRRect(
              borderRadius: BorderRadius.circular(12),
              child: Image(
                image: billing.billPhotoUrl!.startsWith('http')
  ...
  Widget _buildLogMinorTile(BuildContext context, String label, String value, IconData icon) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Text(value, style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.8), fontSize: 13, fontWeight: FontWeight.bold)),
      ],
    );
  }
