    ...
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            children: [
              _buildSummaryCard('TOTAL BUSINESS', total, DesignSystem.electricBlue),
              const SizedBox(width: 12),
              _buildSummaryCard('PAID AMOUNT', paid, DesignSystem.success),
            ],
          ),
          const SizedBox(height: 12),
          _buildSummaryCard('PENDING BALANCE', pending, DesignSystem.error, isWide: true),
        ],
      ),
    );
  }
      ...
      child: ProfessionalCard(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              title,
              style: TextStyle(color: DesignSystem.coolGrey, fontSize: 9, fontWeight: FontWeight.w800, letterSpacing: 1),
            ),
          ],
        ),
      ),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(m.category.icon, color: DesignSystem.deepNavy, size: 20),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: DesignSystem.coolGrey, fontSize: 12),
                          ),
                        ],
                      ),
                    ),
