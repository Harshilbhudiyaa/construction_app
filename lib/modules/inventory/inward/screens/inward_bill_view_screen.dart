      ...
      children: [
        Expanded(
          child: Container(
            ...
            child: Center(
              child: Icon(icon, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.24), size: 32),
            ),
          ),
        ),
        ...
        Text(
          label.toUpperCase(),
          style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.5), fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 0.5),
        ),
      ],
    );
  }
      ...
      child: Column(
        children: [
              ...
              Expanded(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: Colors.greenAccent.withValues(alpha: 0.3), blurRadius: 10, offset: const Offset(0, 4))],
                  ),
          ...
          Text(
            ...
            style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.4), fontSize: 10, fontWeight: FontWeight.w500),
          ),
        ],
      ),
    );
  ...
  Widget _kv(BuildContext context, String k, String v, {IconData? icon, bool isHeader = false}) {
    return Padding(
      ...
      child: Row(
        children: [
          if (icon != null) ...[
            Icon(icon, size: 16, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.24)),
            const SizedBox(width: 12),
          ],
          Text(
            k,
            style: TextStyle(
              color: isHeader ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.onSurface.withOpacity(0.54),
