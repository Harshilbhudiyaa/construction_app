...
class _PartyFormScreenState extends State<PartyFormScreen> {
  ...
  final _partyService = PartyRepository();
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Party saved successfully'), backgroundColor: bcSuccess),
          );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Error saving party: $e'), backgroundColor: bcDanger),
          );
        }
      } finally {
        ...
        child: NestedScrollView(
          headerSliverBuilder: (context, innerBoxIsScrolled) => [
            SmartConstructionSliverAppBar(
              ...
              subtitle: 'Manage supplier and client profiles',
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading 
                        ? const SizedBox(width: 24, height: 24, child: CircularProgressIndicator(color: bcNavy, strokeWidth: 2)) 
                        : Text(
