  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Add Engineer (next step)'))),
      ...
      body: ListView(
        ...
        children: [
          AppSearchField(hint: 'Search engineers...', onChanged: (v) => setState(() => _q = v)),
          const SectionHeader(title: 'List', subtitle: 'Engineers with site + shift (UI-only)'),
          ...filtered.map((e) => Padding(
                ...
                child: Card(
                  child: ListTile(
                    ...
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Open engineer: ${e.$1} (next step)'))),
                  ),
                ),
              )),
