          ...
          child: Column(
            children: [
              _ActionTile(
                ...
                subtitle: 'Manage skills, shifts, and payout rates',
                onTap: () => onNavigateTo(1),
              ),
              _ActionTile(
                icon: Icons.engineering_rounded,
                title: 'Engineering Management',
                subtitle: 'Site permissions and deployment control',
                onTap: () => onNavigateTo(2),
              ),
              _ActionTile(
                icon: Icons.precision_manufacturing_rounded,
                title: 'Production Assets',
                subtitle: 'Machine utilization and block yields',
                onTap: () => onNavigateTo(3),
              ),
              _ActionTile(
                icon: Icons.inventory_2_rounded,
                title: 'Inventory Control',
                subtitle: 'Threshold management and supply levels',
